...
- bd5b7db: Add a new `sfcc/no-string-equals` rule to disallow Java-style `.equals(...)` calls and suggest strict equality (`===`) instead.
...
- 8c8dcf1: Test patch release for the simplified Changesets-based publish workflow.
